...
public class SwaggerConfig {
    ...
    private ApiKey apiKey() {
        return new ApiKey(JSWConstant.TOKEN_NAME, JSWConstant.AUTHORIZATION_HEADER, "header");
    }
    ...
    List<SecurityReference> defaultAuth() {
        ...
        return Arrays.asList(new SecurityReference(JSWConstant.TOKEN_NAME, authorizationScopes));
    }
